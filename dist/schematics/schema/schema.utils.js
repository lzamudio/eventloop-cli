...
function addDeclarationToConst(content, constantName, constantValue) {
...
exports.addDeclarationToConst = addDeclarationToConst;
function insertNewDefinitionOnSameLine(line, constantName, constantValue) {
...
function isAloneBracket(line) {
    const lineWithoutBlankSpaces = line.replace(/\s/g, '');
    return lineWithoutBlankSpaces === '}' || lineWithoutBlankSpaces === '};';
}
function buildLineWithComma(line) {
    const lineWithoutBlankSpaces = line.replace(/\s/g, '');
...
function generateSchemaNameValue(constantName, constantValue) {
